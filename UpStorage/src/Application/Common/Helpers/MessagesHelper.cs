    ...
    public static class Email
    {
        public static class Confirmation
        {
            ...
            public static string ActivationMessage =>
                "Thank you for signing up to UpStorage! In order to activate your account please click the activation button given below.";
            ...
            public static string ButtonLink(string email,string emailToken) => 
                $"https://upstorage.app/account/account-activation={email}&token={emailToken}";
